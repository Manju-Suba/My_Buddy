...
function getRsOnBoardingData(){
    $(TABLE_NAME).DataTable({
        ...
        'ajax': {
            'url': BASE_URL + 'get_rs_onboarding_data',
            'data': function(data) {
                data.status = STATUS;
            }
        },
...
function openApproveModel(id){
    ...
    if(type == 'Approved'){
        ...
        $("#approve_rs_appoinment").attr('hidden', false);
        $("#reject_rs_appoinment").attr('hidden', true);
        $("#approve_rs_appoinment").html("Move to SAP")
    }
...
function appoinmentView(id){
    $.ajax({
        url:  BASE_URL + 'viewRsOnboardingData',
        type: 'POST',
        data: {id: id},
        success: function(data){
            ...
            var common_url = url + 'uploads/rs_appointment/';
                $("#gst_copy").html(`
...
$('#approve_rs_appoinment').click(function(e){
    e.preventDefault();
    updateData('Approved');
});

$('#reject_rs_appoinment').click(function(e){
    e.preventDefault();
    updateData('Rejected');
});
...
function updateData(type){
    ...
    var url = BASE_URL + 'updateRsOnboardingData';
    $.ajax({
        url: url,
        type: 'POST',
        data: {id: id, type: type,status:UPDATE_STATUS},
        success: function(data){
            $('#rs_appoinment_modal').modal('hide');
            getRsOnBoardingData();
            moved_to_sap();
        }
    });
