...
function getRsOnBoardingData(){
    var url = BASE_URL + '/CommonController/get_onboarding_data';
    $(TABLE_NAME).DataTable({
        ...
        'ajax': {
            ...
            'data': function(data) {
                data.status = STATUS;
                data.status_field = UPDATE_STATUS;
            }
        },
        "columns": [
...
function openApproveModel(id){
    ...
    if(STATUS == 'Approved'){
        ...
        $("#reject_rs_appoinment").attr('hidden', false);
    }
    appoinmentView(id)
...
function updateData(type){
    var id = $('#approve_id').val();
    var url = BASE_URL + '/CommonController/updateRsOnboardingData';
    $.ajax({
        url: url,
        type: 'POST',
