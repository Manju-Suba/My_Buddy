...
function get_entered_forms() {
    var example = $('#enteredForm_tb').DataTable({
        ...
        'ajax': {
            'url': BASE_URL + 'RSController/get_entered_rsforms',
            'data': function (data) {
        ...
        createdRow: function (row, data, dataIndex) {
            ...
            $( row ).find('td:eq(8)').attr('data-label', 'Score');
...
function format(d) {
    ...
    return '<table class="table" cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;" id="child_view">' +
        ...
        '</tr>' +
        '<tr>' +
        '<td class="hide table-info"><strong>Shop Name</strong></td>' +
        '<td>' + d.c_sname + '</td>' +
        '</tr>' +
        '<tr>' +
        '<td class="hide table-info"><strong>GST No</strong></td>' +
        '<td>' + d.c_gst_no + '</td>' +
        '</tr>' +
        '<tr>' +
