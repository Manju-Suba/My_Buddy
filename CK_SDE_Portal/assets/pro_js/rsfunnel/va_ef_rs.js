...
function get_tso_list() {
	...
	$.ajax({
		type: "POST",
		url: BASE_URL + 'VAController/get_tso_list_va',
		data: {
			"va_number": va_number,
			"business": business,
		},
...
function get_business() {
	...
	$.ajax({
		type: "POST",
		url: BASE_URL + 'PageController/get_business_list',
		data: {},
		dataType: "json",
		success: function (data) {
			if (data.length != 0) {
...
function get_entered_forms() {
    var example = $('#enteredForm_tb').DataTable({
        ...
        'ajax': {
            'url': BASE_URL + 'VAController/get_entered_rsforms_va',
            'data': function (data) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.length != 0) {
                ...
                var total_points = Number(data[0].c_age_of_org_point) + Number(data[0].c_comp_handled_point) + Number(data[0].c_retail_serviced_point) + 
                ...
                html +='<td data-label="Slab">'+data[0].c_retail_serviced+'</td>';
...
$('#va_action_btn').on('click',function(){
    ...
    if(get_va_action !=''){
        $.ajax({
            type: "POST",
            url: BASE_URL + 'VAController/process_va_action',
            data: {
