...
<head>
    ...
    <!-- datepicker -->
    <!-- <link rel="stylesheet" href="<?php echo asset_url();?>css/datepicker/bootstrap.min.css" /> -->
...
<body>
                            ...
                            <button class="btn btn-danger" id="reset-btn" type="button">Reset Wizard</button>
                                <div class="tab-content">
                                        ...
                                        <div class="container">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Name</label>
                                                    <select name="key_name" id="key_name" class="form-control single-select">
                                    ...
                                    <div class="tab-pane" role="tabpanel" >
                                        <div class="container">
                                            <center>
                                                <button class="btn btn-success " onclick="location.href='<?php echo base_url();?>index.php/rsfunnel/RSController/list_rs_key_form'" id="hiddenbtm" type="submit" value="submit" >Submit</button>
    ...
    <!-- function js -->
    <script src="<?php echo asset_url();?>pro_js/rsfunnel/add_rs_key.js"></script>
    <!-- date formate js  -->
