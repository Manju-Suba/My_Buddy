...
<body>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable  modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Mothly Score Details</h5>
                            ...
                            <div class="table-responsive">
                                <table  id="scoreForm_tb" width="100%" border="1" class="table table-striped table-bordered" cellpadding="5" cellspacing="5">
                                    <?php //echo"<pre>";print($data[0]);?>
                                     ...
                                     <tr>
                                         <td>FF Absenteeism (HoW & Total calls condition)</td>
                                         <td>5</td>
                                     </tr>
                                     <tr>
                                         <td>FF Absenteeism (Actual Absent)</td>
                                         <td>5</td>
                                     </tr>
                                     <tr>
    ...
    <script src="<?php echo asset_url();?>pro_js/rsfunnel/rs_score_rep.js"></script>
    <!--notification js -->
