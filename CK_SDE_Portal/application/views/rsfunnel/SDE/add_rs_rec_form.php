...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div id="smartwizard">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link li_step_3" id="li_step_3" href="#step-3"> <strong>Confirmation</strong> </a>
                                    </li>
                                        ...
                                        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1"
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label>Existing RS Name</label>

                                                        <input type="text" name="c_ex_rs_name" id="c_ex_rs_name"
                                                            class="form-control" placeholder="Existing RS Name">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>GST</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="c_mobile_no"
                                                            id="c_mobile_no" onkeypress="return isNumber(event)"
    ...
    <script src="<?php echo asset_url();?>pro_js/rsfunnel/SDE/add_rs_rec.js"></script>
