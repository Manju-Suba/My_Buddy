...
<body>
                                        ...
                                        <form action="javascript:void(0)" method="POSt" id="cwForm">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label>Date*</label>
                                                    <input type="date" class="form-control" name="cw_date" id="cw_date" placeholder="dd-mm-yyyy" required/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" name="cw_file[]" multiple id="cw_file"  accept=".png, .jpg, .jpeg, .PNG, .JPG, .JPEG" />
                                            </div>
    ...
    <script src="<?php echo asset_url();?>pro_js/ck_competition_watch/add_cw_form.js"></script>
