...
<body>
                                        ...
                                        <div class="container">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="c_name" id="c_name" style="text-transform: capitalize;" class="form-control"
                                                        placeholder="Name">
                                                </div>
                                                <div class="form-group col-md-6">
    ...
    <script src="<?php echo asset_url();?>pro_js/ss_recruitment/edit_ss_rec.js"></script>
