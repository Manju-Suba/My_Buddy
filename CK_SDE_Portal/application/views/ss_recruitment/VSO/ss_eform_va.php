...
<body>
                ...
                <div class="page-content">
                    ...
                    <div class="modal fade" id="action_pop_modal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">VSO Action</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span
                                            aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Status*</label>
                                        <select name="f_vafilter" id="f_vafilter" class="form-control single-select">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-info" id="va_action_btn">Update</button>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    ...
                                    <select name="af_business_list" id="af_business_list"
                            ...
                            <!-- pop image show -->
                            <div id="myModalImg" class="modal fade" style="vertical-align: center;horiz-align: center;">
                                <div class="modal-dialog" style="vertical-align: center;horiz-align: center;">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        </div>
                                        <br>
                                        <div class="modal-body" style="margin-top: -20px;" align="center">

                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    <img id="pop_img_view" width="100%">
                                                </div>
                                            </div>
    ...
    <script src="<?php echo asset_url();?>pro_js/ss_recruitment/VSO/va_ef_ss.js"></script>
    <!--notification js -->
