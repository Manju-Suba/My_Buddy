...
<body>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="smartwizard">
                                <ul class="nav">
                                    <li class="nav-item">
                                        <a class="nav-link li_step_1" id="li_step_1" href="#step-1"> <strong>Basic
                                                Details</strong></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link li_step_2" id="li_step_2" href="#step-2"> <strong>Additional
                                                Details</strong></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link li_step_3" id="li_step_3" href="#step-3">
                                            <strong>Confirmation</strong> </a>
                                    </li>
                                        ...
                                        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1"
                                            ...
                                            <div class="container">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="c_sname" id="c_sname"
                                                            class="form-control" placeholder="Distributor Name">
                                                    </div>
                                                    
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label>Existing SS Name</label>

                                                        <input type="text" name="c_ex_ss_name" id="c_ex_ss_name"
                                                            class="form-control" placeholder="Existing SS Name">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>GST</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label>Upload office/warehouse photos </label>
                                                        <input type="file" class="form-control" name="c_resume"
                                                            id="c_resume" accept=".png, .jpg, .jpeg, .PNG, .JPG, .JPEG" />
                                                    </div>
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="c_towns_serviced" id="c_towns_serviced"
                                                            class="form-control single-select">
                                                            <option value="">Select</option>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="c_computer" id="c_computer" class="form-control">
                                                            <option value="">Select</option>
 ...
 <script src="<?php echo asset_url();?>pro_js/ss_recruitment/validation.js"></script>-->
    ...
    <script src="<?php echo asset_url();?>pro_js/ss_recruitment/SDE/add_ss_rec.js"></script>
    ...
    $(document).ready(function() {
        $("#c_name").keydown(function(event) {
            ...
            if (!(inputValue >= 65 && inputValue <= 120) && (inputValue != 32 && inputValue != 0) &&
                (inputValue != 48 && inputValue != 8) && (inputValue != 9) && (inputValue != 16 &&
                    inputValue != 17) && (inputValue != 20)) {
                validate_name();
                return false;
            }
            return true;
