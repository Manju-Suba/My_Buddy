...
<body>
                ...
                <div class="page-content">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button class="btn btn-info"  onclick="location.href='<?php echo base_url();?>index.php/ss_recruitment/SSController/add_ss_key_form'" type="button">+ Add Performance</button>
                            <hr/>
                            <br> 
                            <div class="table-responsive">
                                <table id="keyForm_tb" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>S.NO</th>
                                            <th>Name</th> 
    ...
    <script src="<?php echo asset_url();?>pro_js/ss_recruitment/key_ss_rec.js"></script>
<!--notification js -->
