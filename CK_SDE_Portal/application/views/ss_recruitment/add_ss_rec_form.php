...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div id="smartwizard">
                                ...
                                <div class="tab-content">
                                    <form action="javascript:void(0)" method="POST" id="ssForm">
                                        ...
                                        <div class="container">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label>Name*</label>
                                                    <input type="text" name="c_name" id="c_name" class="form-control " style="text-transform: capitalize;"
                                                        placeholder="Name" >
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="c_mobile_no"
                                                        id="c_mobile_no" maxlength="10" onkeypress="return isNumber(event)" placeholder="Mobile No">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="c_sname" id="c_sname" class="form-control"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="c_altmobile_no" id="c_altmobile_no"
                                                        class="form-control"onkeypress="return isNumber(event)" placeholder="Alt Mobile No.">
                                                </div>
                                                <div class="form-group col-md-6">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label>State*</label>
                                                    <select name="c_state" id="c_state" class="form-control single-select">
                                                        <option value="">Select</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>Division*</label>
                                                    <select name="c_division" id="c_division" class="form-control single-select">
                                                        <option value="">Select</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-4">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="c_age_of_org" id="c_age_of_org" class="form-control single-select">
                                                    <option value="">Select</option>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="c_comp_handled" id="c_comp_handled" class="form-control single-select">
                                                    <option value="">Select</option>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label>Towns Serviced </label>

                                                    <select name="c_towns_serviced" id="c_towns_serviced" class="form-control single-select">
                                                    <option value="">Select</option>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Godown</label>
                                                    <select name="c_godown" id="c_godown" class="form-control single-select">
                                                    <option value="">Select</option>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Printer</label>
                                                    <select name="c_printer" id="c_printer" class="form-control single-select">
                                                    <option value="">Select</option>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="c_delivery_vehicle" id="c_delivery_vehicle" class="form-control single-select">
                                                    <option value="">Select</option>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="c_prop_invol" id="c_prop_invol" class="form-control single-select">
                                                    <option value="">Select</option>
    ...
    <!-- validate js for form 
 <script src="https://cdn.jsdelivr.net/npm/jquery-validation@1.19.3/dist/jquery.validate.js"></script> 
 <script src="<?php echo asset_url();?>pro_js/ss_recruitment/validation.js"></script>--> 
    ...
    <script src="<?php echo asset_url();?>pro_js/ss_recruitment/add_ss_rec.js"></script>
...
$(document).ready(function(){
    $("#c_name").keydown(function(event){
        ...
        if(!(inputValue >= 65 && inputValue <= 120) && (inputValue != 32 && inputValue != 0)&& 
         (inputValue != 48 && inputValue != 8) && (inputValue != 9)&& (inputValue != 16 && inputValue != 17)&& (inputValue != 20)){ 
            validate_name();
        return false;
        }
        return true;
