...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <?php 
                                            ...
                                            ?>
                                                <!-- <a href="<?php echo base_url();?>index.php/SdeMarket/add_sde_market"><button
							...
							<div id="sde_table_div">
								...
								<table class="table table-bordered">
									<tr>
										...
										<th scope="col" style="background:#078bb336;">Achieved</th>
    ...
    <script src="<?php echo asset_url();?>pro_js/incentive/sde_incentive_urban_individual.js"></script>
