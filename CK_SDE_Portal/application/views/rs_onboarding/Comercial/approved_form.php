...
<head>
    ...
    <title>Comercial Approved</title>
...
<body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="mb-0">RS Onboarding Approved</h4>
                            ...
                            <div class="table-responsive">
                                <table id="comercial_approved_data" class="table table-bordered" style="width:100%">
                                    <thead>
                                        <tr >
                                            <th>S.No</th>
                                            <th>RS Type</th>
    ...
    <script>
        ...
        var STATUS = "Approved";
        var TABLE_NAME = "#comercial_approved_data";
