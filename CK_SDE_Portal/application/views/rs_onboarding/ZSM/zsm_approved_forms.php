                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4 class="mb-0">RS Approved Details</h4>
                            </div>
                            <hr />
                            <div class="">
                                <div class="table-responsive">
                                    <table id="approvedForm_tb" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th>S.No</th>
