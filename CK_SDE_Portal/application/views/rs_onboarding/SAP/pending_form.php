...
<body>
                ...
                <div class="page-content">
                    <div class="card p-4">
                        ...
                        <div class="table-responsive">
                            <table id="sap_pending_data" class="table table-bordered" style="width:100%">
                                <thead>
                                    <tr >
                                        <th>S.No</th>
                                        <th>RS Type</th>
    ...
    <script src="<?php echo asset_url(); ?>pro_js/rs_onboarding/SAP/sap.js"></script>

    <script>
        var BASE_URL = "<?php echo base_url();?>index.php/rs_onboarding/SapController/";
        var STATUS = "Pending";
        var TABLE_NAME = "#sap_pending_data";
        var UPDATE_STATUS = "sap_status";
