...
<body>
                        ...
                        <div class="pl-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Outlet Details</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="mb-0">Outlet Details</h4>
										...
										<div class="modal-body">
											<form action="javascript:void(0)" method="POSt" id="uploadForm" class="">
												<div class="form-group">
													<p>&nbsp;Sample Excel <a href="<?php echo asset_url();?>sample_excel/beat_excel/Sample_Excel.xlsx">DOWNLOAD</a> &nbsp;&nbsp;&nbsp;<b style="color:red;">*Note - Supported File Format(.xlsx).</b></p>
												</div>
												<div class="form-group">
													<div class="row">
														<div class="col-md-8">
                            ...
                            <div class="table-responsive">
								<?php if( $this->session->userdata('role_type') != 'TSO' && $this->session->userdata('role_type') != 'SM'){ ?>

									<table id="beat_report_vw" class="table table-bordered" style="width:100%">
										<thead>
											<tr class="table-info">
												<th id="sn">Sno</th>
												<th>Dist Name</th>
								...
								<?php } ?>
								<?php if( $this->session->userdata('role_type') === 'TSO' || $this->session->userdata('role_type') === 'SM'){ ?>
									<table id="beat_report_vw_sde" class="table table-bordered" style="width:100%">
										<thead>
											<tr class="table-info">
												<th id="sn">Sno</th>
												<th>Dist Name</th>
    ...
    <script> 
        $(document).ready(function() {
            ...
            var page = "beat_report_view";

            if (page == "beat_report_view") {
                $(".eform_rm").addClass("mm-active");
            }
