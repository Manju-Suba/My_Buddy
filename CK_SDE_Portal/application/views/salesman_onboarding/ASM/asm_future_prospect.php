...
<head>
    ...
    <style>
        ...
        .above_avr_salary {
            background-color: #e99898ad; /* Change this to your desired color */
        }
    </style>
</head>
...
<body>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <button type="button" class="btn btn-primary modal_trigger_btn" data-toggle="modal"
                        ...
                        Modal</button>
                    <!-- Modal -->
                    <div class="modal fade" id="adt_details_modal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static"
                        data-keyboard="false">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class=" row ">
                                        ...
                                        <span  style= "display:none" id="table_row_id"></span>

                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <!-- <button type="button" class="btn btn-info" id="approved">Approved</button>
                                    <button type="button" class="btn btn-info" id="future_prospect">Future
                                        Prospect</button> -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4 class="mb-0">Future Prospect Forms</h4>
                            </div>
                            <hr />
                            <div class="row">
                                <div class="col-md-3">
    ...
    <script src="<?php echo asset_url(); ?>pro_js/sales/ASM/asm_fprospect_forms.js"></script>
    <!--notification js -->
    ...
    <script>
        ...
        $(".asm_fprospect_m").addClass("mm-active");
