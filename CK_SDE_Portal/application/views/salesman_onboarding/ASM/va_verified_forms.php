...
<head>
    ...
    <style>
        ...
        .above_avr_salary {
            background-color: #e99898ad; /*#e99898ad Change this to your desired color */
        }
        .td {
            white-space: nowrap;
            overflow: hidden;
...
<body>
                        ...
                        <div class="modal-dialog modal-xl modal-lg modal-md modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-info" id="approved">Approve</button>
    ...
    <script>
        ...
        function image_view(image) {
            // alert(image);
            $("#image_view").attr("src", "<?php echo base_url(); ?>/uploads/image/" + image);
            $(".image-preview").modal('show');
        }
    </script>
    <!-- App JS -->
