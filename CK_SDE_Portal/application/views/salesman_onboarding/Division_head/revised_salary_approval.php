...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-sm-4 col-md-3 col-lg-2 td" style="display: flex; align-items: center;">
                                            <span id="service_fee"></span>
                                            <div class="btn btn-sm ml-1" id="edit_service_fee" style="padding: 0.2rem 0.2rem !important;"><i class="fa fa-pencil" style="font-size: 1.2rem;"></i></div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-success" id="approve_fee">Approve</button>
                                    <button type="button" class="btn btn-danger" id="reject_fee">Reject</button>
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal fade reject_reason" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="reject_reason" aria-hidden="true" data-keyboard="false">
                            ...
                            <div class="modal-content" style="margin-top: 7rem">
                                ...
                                <div class="modal-body col-12">
                                    <div class="row" style="align-items:center; margin:0px">
                                        <label class="col-6" for="rej_reason"><b>Reason for Rejection  </b></label>
                                        <textarea class="form-control col-6" name="rej_reason" id="rej_reason" rows="2"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger rejected" id="submit_reason">Reject</button>
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                </div>
                            </div>
                    ...
                    <div class="modal fade edit_fee" id="edit_fee"tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="reject_reason" aria-hidden="true" data-keyboard="false">
                        <div class="modal-dialog modal-md ">
                            <div class="modal-content" style="margin-top: 7rem">
                                <div class="modal-header">
                                    <h5>Update Service Fee</h5>
                                </div>
                                <!-- <hr> -->
                                <form action="" id="update_fee">
                                    <div class="modal-body col-12">
                                        <div class="row mb-2" style="align-items:center; margin:0px">
                                            <label class="col-6" for="sales_category"><b>Sales Category</b></label>
                                            <input class="form-control col-6" type="text" name="sales_category" id="sales_category" readonly>
                                        </div>
                                        <div class="row mb-2" style="align-items:center; margin:0px">
                                            <label class="col-6" for="fee_limit"><b>Fee Limit</b></label>
                                            <input class="form-control col-6" type="text" name="fee_limit" id="fee_limit" readonly>
                                            <input class="form-control col-6" type="hidden" name="rs_id" id="rs_id" readonly>
                                            <input class="form-control col-6" type="hidden" name="div_head_status" id="div_head_status" value="Approved" readonly>
                                        </div>
                                        <div class="row mb-2" style="align-items:center; margin:0px">
                                            <label class="col-6" for="given_fee"><b>Given Service Fee</b></label>
                                            <input class="form-control col-6" type="text" name="given_fee" id="given_fee" readonly>
                                        </div>
                                        <div class="row mb-2" style="align-items:center; margin:0px">
                                            <label class="col-6" for="new_fee"><b>Revised Service Fee</b></label>
                                            <input class="form-control col-6" type="text" name="new_fee" id="new_fee" onkeypress="return /[0-9.]/i.test(event.key)">
                                        </div>
                                    </div>
                                </form>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger"  id="approve_revised_fee" disabled>Approve</button>
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="revised_fee_table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Sno</th>
    ...
    <script src="<?php echo asset_url();?>pro_js/sales/Div_Head/revised_salary_Approval.js"></script>
