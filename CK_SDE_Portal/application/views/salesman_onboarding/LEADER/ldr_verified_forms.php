...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <!-- <div class="col-md-3">
                                    ...
                                    <select name="af_zsm_list" id="af_zsm_list" class="form-control form-control-sm single-select">
    ...
    <script src="<?php echo asset_url();?>pro_js/sales/LEADER/ldr_verified_forms.js"></script>
    <!--notification js -->
