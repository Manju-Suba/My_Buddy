...
<body>
    ...
    <script src="<?php echo asset_url(); ?>pro_js/sales/LEADER/rssm_verified.js"></script>
...
var url = "<?php echo base_url();?>";
        ...
        $(document).ready(function () {
            // image_popup_viewer();
            $(".rssm_verified_m").addClass("mm-active");
        });
