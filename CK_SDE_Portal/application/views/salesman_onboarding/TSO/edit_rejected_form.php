...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <div class="card">
                        <div class="card-header">Re-edit Recruitment Form</div>
                        <div class="card-body">
                            ...
                            <div id="smartwizard">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link li_step_2" href="#step-2"> <strong>Additional Details</strong></a>
                                    </li>
                                    <li class="nav-item li_step_3">
                                        <a class="nav-link " href="#step-3"> <strong>Other Details</strong> </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link li_step_4" href="#step-4"> <strong>Bank Details</strong> </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <form action="javascript:void(0)" method="POST" id="reeditrssmForm">
                                            ...
                                            <div class="container">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="c_mobile_no" id="c_mobile_no" placeholder="Mobile No" onkeypress="return /[0-9.]/i.test(event.key)" pattern="[0-9]*" inputmode="numeric">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>WhatsApp No. <span class="req">*</span></label>
                                                        <input type="text" name="c_altmobile_no" id="c_altmobile_no" class="form-control" placeholder="Alt Mobile No." onkeypress="return /[0-9.]/i.test(event.key)" pattern="[0-9]*" inputmode="numeric">
                                                    </div>
                                                    <!-- </div>
                                                    <div class="form-row"> -->
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label>Salesman Live Image Capture <span style="color:red;">(If you want to upload again)</span></label>
                                                        <input type="file" class="form-control" name="image_file" id="image_file" accept="image/*" capture=camera />
                                                        <div class="form-group ">
                                                            <label>Salesman Live Image View </label>
                                        ...
                                        <div id="step-4" class="tab-pane" role="tabpanel" aria-labelledby="step-4">
                                            <div class="container">
                                                <div class="form-row">
                                                    <div class="col-md-4 pt-3" style="display: inline-block; padding: 0px">
                                                    ...
                                                    <div class="col-md-2 padleft pt-3" style="display: inline-block;padding: 0px">
                                                    ...
                                                    <div class="col-md-2 pt-3 pr-1" style="display: inline-block; padding: 0px">
                                                        <label for="income">Aadhar copy (Front Side) </label>
                                                        <input type="file" name="aadhar_copy" class="form-control" id="aadhar_copy" accept="image/*">
                                                        <span class="em" id='aadhar_num_er'></span>
                                                    </div>

                                                    <div class="col-md-2 pt-3" style="display: inline-block; padding: 0px">
                                                        <label for="income">Aadhar copy (Back Side)</label>
                                                    ...
                                                    <div class="col-md-4 padleft pt-3" style="display: inline-block;">
                                                        <label for="income">PAN View </label>
                                                        <div style="padding-left: 20px;">
                                                            <span id="pan_view"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 pt-3" style="display: inline-block; padding: 0px">
                                                        <label for="income">PAN Copy <span style="color:red;">(If you want to upload again)</span></label>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4 pt-3" >
                                                        <label for="income">Cheque Copy <span style="color:red;">(If you want to upload again)</span></label>
                                                        <input type="file" name="cheque_copy" class="form-control"
                                                            id="cheque_copy" accept="image/*">
                                                        <span class="em"></span>

                                                    </div>
                                                    <div class="col-md-4 pt-3 padleft" style="display: inline-block;">
                                                        <label for="income">Cheque View </label>
                                                        <div style="padding-left: 20px;">
                                                ...
                                                <div class="col-md-5" style="margin-left: 4%;">
                                                    ...
                                                    <button class="btn btn-info save_btn m-1" type="button" id="reedit_SaveBtn">Save</button>
                                                    <button class="btn btn-success m-1" type="submit" id="reedit_SubmitBtn">Submit</button>
                                                </div>
                                                </div>
                                                ...
                                                <!-- <div class="form-row">
                                                    ...
                                                    if ($this->session->userdata('role') == 'TSO') {
                                                        ?>
                                                        <button class="btn btn-info save_btn" type="button" id="SaveBtn">Save</button>
                            ...
                            <div class="modal fade" id="confirm_approval_re" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <script>
        $(".rejected_form").addClass("mm-active");
