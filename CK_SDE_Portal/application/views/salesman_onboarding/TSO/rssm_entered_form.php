...
<body>
                        ...
                        <div class="modal-dialog modal-xl modal-lg modal-md modal-sm">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"><b>SalesMan Details</b></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4 class="mb-0">Raised Requests</h4>
                            </div>
                            <hr />
                            <div class="">
                                <ul class="nav nav-tabs nav-tabs-custom nav-justified mb-3" role="tablist" style="font-size: 16px;">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#funnel_forms" role="tab">
                                ...
                                <div class="tab-content p-3 text-muted">
                                    ...
                                    <!-- <div class="tab-pane  dt-ext-responsive" id="funnel_forms"> -->
                                    <!-- <div class="tab-content p-3 text-muted"> -->
                                    <div class="tab-pane dt-ext-responsive" id="funnel_forms">
                                        <div class="table-responsive">
                                            <table id="funnelForm_tb" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Sno</th>
    ...
    <script src="<?php echo asset_url(); ?>pro_js/sales/TSO/ef_rssm_rec.js"></script>
    <script src="<?php echo asset_url(); ?>pro_js/sales/TSO/ff_rssm_rec.js"></script>
