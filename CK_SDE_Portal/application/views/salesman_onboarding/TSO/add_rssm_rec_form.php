...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div id="smartwizard">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link li_step_3" id="li_step_3" href="#step-3"> <strong>Other Details</strong> </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link li_step_4" id="li_step_4" href="#step-4"> <strong>Bank Details</strong> </a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="container">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="c_mobile_no" id="c_mobile_no" placeholder="Mobile No"  onkeypress="return /[0-9.]/i.test(event.key)" maxlength="10"  inputmode="numeric">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>WhatsApp No. <span class="req">*</span></label>
                                                        <input type="text" name="c_altmobile_no" id="c_altmobile_no" minlenght="10" class="form-control" onkeypress="return /[0-9.]/i.test(event.key)"
                                                            placeholder="WhatsApp No." maxlength="10" pattern="[0-9]*" inputmode="numeric">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="file" class="form-control" name="c_resume" id="c_resume" accept=".xlsx,.xls,.doc, .docx,.ppt, .pptx,.txt,.pdf" />
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="rssm_select" id="rssm_select"
                                                            class="rssm_select form-control single-select">
                                                            <option value="">Select </option>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label>SalesMan Live Image Capture <span class="req">*</span></label>
                                                        <input type="file" class="form-control" name="image_file" id="image_file" accept="image/*" capture=camera />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="c_experience" id="c_experience"
                                                            class="form-control single-select">
                                                            <option value="">Select</option>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="c_education" id="c_education"
                                                            class="form-control single-select">
                                                            <option value="">Select</option>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="c_tknowledge" id="c_tknowledge"
                                                            class="form-control single-select">
                                                            <option value="">Select</option>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="c_tech_adaption" id="c_tech_adaption"
                                                            class="form-control single-select">
                                                            <option value="">Select</option>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="c_familybg" id="c_familybg"
                                                            class="form-control single-select">
                                                            <option value="">Select</option>
                                                        </select>
                                                    </div>
                                        ...
                                        <div id="step-3" class="tab-pane" role="tabpanel3" aria-labelledby="step-3">
                                            <div class="container">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="rssm_type">Sales Type <span
                                                                class="req">*</span></label>
                                                        <select name="rssm_type_select" id="rssm_type_select"
                                                            class="rssm_select form-control single-select">
                                                            <option value="">Select</option>
                                                ...
                                                <div id="new_rssm" style="display:none">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select class="form-control single-select"
                                                                name="select_rs_name" id="select_rs_name"
                                                                placeholder="RS Name">
                                                                <option value="">select</option>
                                                            </select>
                                                            <span class="em"></span>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select type="text" name="c_town" id="c_town" class="form-control single-select">
                                                                <option value="">Select</option>
                                                            </select>
                                                            <span class="em"></span>
                                                        </div>
                                                    ...
                                                    <div class="form-row" style="display:flex; align-items:center">
                                                        <button type="button" class = "btn btn-sm ml-1 mb-3 btn-info" id="add_beat" title="Add Beat" style=""><i class="fa fa-plus" style="font-size:12px; "></i> ADD </button>
                                                ...
                                                <div id="ex_rssm" style="display:none">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            <label>Existing SalesMan Name <span class="req">*</span></label>

                                                            <input type="text" class="form-control" name="c_ex_rssm_name" id="c_ex_rssm_name" placeholder="Existing SalesMan Name">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="ex_rssm_number">Existing SalesMan Number <span class="req">*</span></label>
                                                            <input type="text" name="ex_rssm_number" id="ex_rssm_number" onkeypress="return /[0-9.]/i.test(event.key)" class="form-control" placeholder="Existing SalesMan Number">
                                                        </div>
                                                    </div>
                                                    <!-- <div class="form-row">
                                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="container">
                                                <div class="form-row">
                                                    <div class="col-md-6 ">
                                                        ...
                                                        <input type="text" name="aadhar_num" onkeypress="return /[0-9.]/i.test(event.key)" class="form-control" id="aadhar_num" >
                                                        <span class="em" id='aadhar_num_er'></span>
                                                       
                                                        <!-- <div class="col-md-6"
                                                            style="display: inline-block; padding: 1px">
                                                            <label for="income">Aadhar copy <span class="req">*</span></label>
                                                            <input type="file" name="aadhar_copy" class="form-control" id="aadhar_copy" accept="image/*" >
                                                            <span class="em" id='aadhar_num_er' ></span>
                                                        </div> -->
                                                    </div>
                                                    <div class="form-group col-md-6 form-row">
                                                        
                                                        <div class="col-md-6"style="display: inline-block; padding: 1px">
                                                            <label for="income">Aadhar copy (Front Side) <span class="req">*</span></label>
                                                            <input type="file" name="aadhar_copy" class="form-control" id="aadhar_copy" accept="image/*" >
                                                            <span class="em" id='aadhar_num_er' ></span>
                                                        </div>
                                                        <div class="col-md-6"style="display: inline-block; padding: 1px">
                                                            <label for="income">Aadhar copy (Back Side) <span class="req">*</span></label>
                                                            <input type="file" name="aadhar_copy_b" class="form-control" id="aadhar_copy_b" accept="image/*" >
                                                            <span class="em" id='aadhar_num_er' ></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6 form-row ">
                                                        <div class="col-md-6" style="display: inline-block; padding: 1px">
                                                            <label for="income">PAN Number <span class="req">*</span></label>
                                                            <input type="text" name="pan_num" class="form-control" id="pan_num" >
                                                            <span class="em" id="pan_num_er"></span>
                                                        </div>
                                                        <div class="form-group col-md-6" style="display: inline-block; padding: 1px">
                                                            <label for="income">PAN Copy <span class="req">*</span></label>
                                                            <input type="file" name="pan_copy" class="form-control" id="pan_copy" accept="image/*" >
                                                            <span class="em" id="pan_num_er"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="income">Cheque Copy <span class="req">*</span></label>
                                                        <input type="file" name="cheque_copy" class="form-control" id="cheque_copy" accept="image/*" >
                                                        <span class="em"></span>
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="income">A/C Number <span class="req">*</span></label>
                                                        <input type="text" name="ac_num" class="form-control"maxlength="18" id="ac_num">
                                                        <span class="em"></span>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="income">IFSC Code /Swift Code <span
                                                                class="req">*</span></label>
                                                        <input type="text" name="ifsc_code" class="form-control"
                                                            maxlength="12" id="ifsc_code">
                                                ...
                                                <div class="col-md-5" style="margin-left: 4%;">
                                                    ...
                                                    <input type="hidden" id="div_head_status" name="div_head_status">
    ...
    <script src="<?php echo asset_url(); ?>pro_js/sales/TSO/add_rssm_rec.js"></script>
    ...
    <script type="text/javascript">
        ...
        function updateBeatLabels() {
            $('.beats').each(function (index) {
                var beatlabel = 'beat_label_' + (index + 1);
                var text = 'Beat ' + (index + 1) + '<span class="req">*</span>';
                $(this).find('label').attr('id', beatlabel).html(text);
        ...
        // function lockArrowKeys(event) { // Get the key code of the pressed key 
        //     var keyCode = event.keyCode || event.which; // List of arrow key keycodes 
        //     var arrowKeys = [37, 38, 39, 40]; // Prevent the default behavior for arrow keys 
        //     if (arrowKeys.indexOf(keyCode) !== -1) { event.preventDefault(); } 
        // }
