...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="modal fade update_sevicefee" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="reject_reason" aria-hidden="true" data-keyboard="false">
                        <div class="modal-dialog modal-md ">
                            <div class="modal-content">
                                ...
                                <div class="modal-body col-12">
                                    <div class="row mb-3" style="align-items:center; margin:0px">
                                        <label class="col-6" for="rej_reason"><b>Service Fee<span class="text-danger">*</span> </b></label>
                                        <input type="text" class="form-control col-6" name="service_fee" id="update_service_fee" onkeypress="return /[0-9.]/i.test(event.key)" required>
                                        <input type="hidden" class="form-control col-6" name="row_id" id="row_id" required>
                                    </div>
                                    <div class="row " id="divhead_comment"style="display:none;align-items:center; margin:0px">
                                        <label class="col-6" for="rej_reason"><b> Remarks: </b></label>
                                        <span class="text-danger" id="divhead_remark"></span>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-success update_fee">Submit</button>
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4 class="mb-0">Rejected Forms</h4>
                            </div> 
                            <hr />
                            <ul class="nav nav-tabs nav-tabs-custom nav-justified mb-3" role="tablist" style="font-size: 16px;">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#asm_future_prospect" role="tab">
                                            <span class="d-none d-sm-block">ASM Future Prospect</span>
                                            <!-- <span class="d-none d-sm-block">Rejected By ASM</span> -->
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#rejected_service_fee" role="tab">
                                            <span class="d-none d-sm-block">Rejected Based on Service Fee</span>
                                        </a>
                                    </li>  
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#rejected_by_rssm" role="tab">
                                            <span class="d-none d-sm-block">Rejected by Hiring Team</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active dt-ext-responsive" id="asm_future_prospect">
                                        <table id="asm_fp" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Sno</th>
                                    ...
                                    <div class="tab-pane  dt-ext-responsive" id="rejected_service_fee">
                                        <table id="rejectedfee_tb" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Sno</th>
                                    ...
                                    <div class="tab-pane  dt-ext-responsive" id="rejected_by_rssm">
                                        <table id="rejectedForm_tb" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Sno</th>
    ...
    <script src="<?php echo asset_url(); ?>pro_js/sales/TSO/rssm_rejected.js"></script>
    <script src="<?php echo asset_url(); ?>pro_js/sales/TSO/divheadrejected.js"></script>
