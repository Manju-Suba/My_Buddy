...
<body>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body col-12">
                                    <div class="row" style="align-items:center; margin:0px">
                                        ...
                                        <input type="text" class="form-control col-6" name="service_fee" id="update_service_fee" required>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4 class="mb-0">Rejected Service Fee</h4>
                            </div>
                            <hr />
    ...
    <script>
        ...
        $(document).ready(function () {
            $(".rejected_fee_form").addClass("mm-active");
