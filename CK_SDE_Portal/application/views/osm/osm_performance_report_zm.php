...
@media (min-width: 334px) and (max-width: 380px) {
		...
		.fc-event, .fc-event-dot {
			...
			/* background-color: #e5b71240; */
			/* border: 1px solid #e98f1ff2; */
		...
		/* .fc-content-skeleton table thead .fc-day-top.fc-past.fc-title{
				color:white;
			} */
...
<body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
								...
								<div class="col-md-3" >
									<div id="hidden_div1" style="display:none;" class="jc_view">
										<label>Financial Year </label>
										<select class="form-control" id="_year" name="_year" style="margin-top: -6px;"></select>
										<!-- <input class="date-own form-control" style="width: 224px;margin-top: -6px;" id="_year" name="_year" type="text" autocomplete="off" placeholder="2023"> -->
										<!-- <input type="text" class="form-control date-set" id="_year" name="_year" value="" style="margin-top: -6px;" autocomplete="off" placeholder="2023"/> -->
									</div>
								</div>
								<div class="col-md-3" >
							...
							<div class="row">
								<div class="col-md-3 lead_view" style="display:none;">
									...
									<select class="form-control" name="business" id="business"  style="margin-top: -6px;">
								...
								<div class="col-md-3 lead_view" style="display:none;">
                                    ...
                                    <select name="af_asm_list" id="af_zsm_list" class="form-control" style="margin-top: -6px;">
										<option value="">View All</option>
                                    </select>
                                </div>
                                <div class="col-md-3 lead_view zsm_view" style="display:none;">
                                    <label for="">ASM Name</label>
                                    <select name="af_asm_list" id="af_asm_list" class="form-control" style="margin-top: -6px;">
										<option value="">View All</option>
                                    </select>
                                </div>
    ...
    <script src="<?php echo asset_url();?>plugins/notifications/js/notifi/cation-custom-script.js"></script>
    ...
    <script src="<?php echo asset_url();?>pro_js/osm/osm_performance_zm.js"></script>
