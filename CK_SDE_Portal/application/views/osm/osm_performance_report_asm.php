...
<body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
								...
								<div class="col-md-3 jc_view form-group" id="hidden_div1" style="display:block;">
								...
								<div class="col-md-3 jc_view form-group" id="hidden_div" style="display:block;">
									<label>JC </label>
								...
								<div class="col-md-3 lead_view zsm_view asm_view form-group" style="display:none;">
									<label for="">SDE Name</label>
									<select name="af_tso_list" id="af_tso_list" class="form-control" style="margin-top: -6px;">
										<option value="">View All</option>
									</select>
								</div>
								...
								<!-- <div class="col-md-9"> -->
									<!-- <div class="row"> -->
										<!-- <div id="hidden_div1" style="display:block;" class="col-md-2 jc_view">
											<label>Year </label>
											<input class="date-own form-control" style="width: 97px;margin-top: -6px;" id="_year" name="_year" type="text" autocomplete="off" placeholder="2023">
										</div> -->
										<!-- <div id="hidden_div" style="display:block;" class="col-md-2 jc_view">
											<label>JC </label>
											<select class="form-control" name="jc_type" id="jc_type" style="margin-top: -6px;">
												<option value="">View All</option>
										...
										<!-- <div class="col-md-4 lead_view zsm_view asm_view" style="display:none;">
											<label for="">SDE Name</label>
											<select name="af_tso_list" id="af_tso_list" class="form-control" style="margin-top: -6px;">
												<option value="">View All</option>
											</select>
										</div> -->
										<!-- <div class="col-md-4 lead_view zsm_view asm_view tso_view" style="display:none;">
											<label for="">OSM Name</label>
											<select name="af_sm_list" id="af_sm_list" class="form-control" style="margin-top: -6px;">
												<option value="">View All</option>
											</select>
									...
									<table id="osm_table" class="table table-bordered" style="width:100%">
										<thead>
											...
											<tr class="table-info">
												...
												<th>Calls Made/SM/Day</th>
												<th>Productive Calls (sum)</th>
												<th>Productive Calls/SM/Day</th>
												<th>Productivity %</th>
									...
									<table id="" class="table table-bordered" style="width:100%">
										<thead>
											<tr style="position: sticky; top: -1px; z-index: 1; ">
												...
												<th class="weekly_row" colspan="2"></th>
    ...
    <script src="<?php echo asset_url();?>pro_js/osm/osm_performance_asm.js"></script>
    <script>
        $(document).ready(function() {
            $(".metismenu li").removeClass('mm-active');
            var page = "osm_performance_asm";

            if (page == "osm_performance_asm") {
