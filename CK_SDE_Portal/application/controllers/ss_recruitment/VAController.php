...
class VAController extends CI_Controller {  
    ...
    {   
        ...
        $this->load->model('ss_recruitment/Va_model', 'vmodel');
    ...
    public function ss_eform_va(){
        $this->load->view('ss_recruitment/VSO/ss_eform_va');
    }
    ...
    public function get_tso_list_va(){
        ...
        if($this->session->userdata('role') =='VA'){
            ...
            $where_cond['zsm_number'] = $this->input->post('va_number');
        }
    ...
    public function get_entered_ssforms_va(){
        ...
        $get_entered_ssforms_result = $this->vmodel->verify_data_ssforms_va($postData,$postData_where,$postData_where_id);
