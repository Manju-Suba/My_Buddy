...
class ASMController extends CI_Controller {	
    ...
    public function ss_eform_asm(){
		$this->load->view('ss_recruitment/ASM/ss_eform_asm');	
    }
    ...
    public function get_entered_ssforms(){
        ...
        $get_entered_ssforms_result = $this->amodel->verify_data_ssforms($postData,$postData_where,$postData_where_id);

        echo json_encode($get_entered_ssforms_result);
	}

    public function ss_fform_asm(){
        $this->load->view('ss_recruitment/ASM/ss_fform_asm');
    }
    ...
    public function get_funnel_ssforms(){
        ...
        $get_funnel_ssforms_result = $this->amodel->verify_data_ff_ssforms($postData,$postData_where,$postData_where_id);
    ...
    public function va_verified_forms(){
        $this->load->view('ss_recruitment/ASM/va_verified_forms');
    }

    public function asm_verified_forms(){
        $this->load->view('ss_recruitment/ASM/asm_verified_forms');
    }
    
    public function asm_future_prospect(){
        $this->load->view('ss_recruitment/ASM/asm_future_prospect');
    }
...
//echo "<pre>";print_r($get_va_verified_forms_result);die;
