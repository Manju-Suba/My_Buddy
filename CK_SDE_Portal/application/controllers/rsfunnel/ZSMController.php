...
class ZSMController extends CI_Controller {	
    ...
    public function rs_eform_zsm(){
		$this->load->view('rsfunnel/ZSM/rs_eform_zsm');	
    }
    ...
    public function rs_fform_zsm(){
        $this->load->view('rsfunnel/ZSM/rs_fform_zsm');
    }
    ...
    public function va_verified_forms_zsm(){
        $this->load->view('rsfunnel/ZSM/va_verified_forms_zsm');
    }
