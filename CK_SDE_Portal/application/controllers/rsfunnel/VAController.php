...
class VAController extends CI_Controller 
{
    public function __construct(){
        ...
        $this->load->model('Va_model', 'vmodel');
    ...
    public function rs_eform_va(){
        $this->load->view('rsfunnel/VSO/rs_eform_va');
    }
    ...
    public function get_entered_rsforms_va(){
        ...
        $get_entered_rssmforms_result = $this->vmodel->verify_data_rsforms_va($postData,$postData_where,$postData_where_id);
