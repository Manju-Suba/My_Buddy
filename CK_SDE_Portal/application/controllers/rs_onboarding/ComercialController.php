...
class ComercialController extends CI_Controller {	
    ...
    public function pending_form(){	
		$this->load->view('rs_onboarding/Comercial/pending_form');	
	}

    public function approved_form(){	
		$this->load->view('rs_onboarding/Comercial/approved_form');	
	}
