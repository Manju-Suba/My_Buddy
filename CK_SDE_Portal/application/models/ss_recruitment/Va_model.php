...
class Va_model extends CI_Model{
    ...
    function verify_data_ssforms_va($postData,$postData_where,$postData_where_id){
		$response = array();
        //# Read value
		$draw = $postData['draw'];
		...
		foreach ($records as $record) {
            ...
            $action_url2 = base_url()."index.php/SSController/edit_ss_rec_form/".$record->auto_id;
			...
			$action .= ' <a href="'.$action_url2.'"><button  class="btn  btn-sm  ml-1 btn-info dt-btn-st" id="editBtn"><i class="bx bx-pencil"></i></button></a>';
